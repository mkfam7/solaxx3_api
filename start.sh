...
print-help() {
  echo "\
Usage: $0 [-h|--help] [-g|--generate-password] [-q|--quiet] [-u|--create-user] [--prestart COMMAND] [ADDRESS [PORT]]
...
ARGS=$(getopt -o hqgu --long help,quiet,generate-password,create-user,prestart: -n "$0" -- "$@")
if [ $? -ne 0 ];
