...
print-help() {
  echo "\
Usage: $0 [-h|--help] [-g|--generate-password] [-q|--quiet] [-u|--create-user] [-f|--force-create][--prestart COMMAND] [ADDRESS [PORT]]
...
ARGS=$(getopt -o hqguf --long help,quiet,generate-password,create-user,force-create,prestart: -n "$0" -- "$@")
if [ $? -ne 0 ];
